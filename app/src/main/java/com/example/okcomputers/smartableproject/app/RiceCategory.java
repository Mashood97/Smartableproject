...
public class RiceCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                adapter = new FoodItemAdapterBeforeLogin(RiceCategory.this,list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.Login) {
            Intent i = new Intent(RiceCategory.this, LoginActivity.class);
            startActivity(i);
        }
        if (id == R.id.SignUp) {
            Intent i = new Intent(RiceCategory.this, SignupActivity.class);
            startActivity(i);
        }
