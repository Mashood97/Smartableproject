...
public class FishCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                adapter = new FoodItemAdapterBeforeLogin(FishCategory.this,list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.Login) {
            Intent i = new Intent(FishCategory.this,LoginActivity.class);
            startActivity(i);
        }
        if(id == R.id.SignUp)
        {
            Intent i = new Intent(FishCategory.this,SignupActivity.class);
            startActivity(i);
        }
